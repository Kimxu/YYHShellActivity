    ...
    private void init(final Context context, String theme,boolean hasClose) {
        ...
        mIvCancel.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                setVisibility(GONE);
                Toast.makeText(context,"晃动手机发现更多好游戏！",Toast.LENGTH_LONG).show();
        ...
        if(PrefUtil.getBool(PrefUtil.ST_LINK_ACTION,false)) {
            mTvContent.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Uri content_url = Uri.parse(PrefUtil.getString(PrefUtil.ST_LINK_URL,"http://dwz.cn/2fNdMF"));
...
//                logo = am.open("st_dark_logo.png");
            ...
            logo = am.open("st_logo.png");
            bg = am.open("st_bg.png");
        ...
        mTvContent.setText(PrefUtil.getString(PrefUtil.ST_LINK_TEXT,"来手谈汉化组贴吧发现更多精彩游戏和内容!"));
